            ...
            <div className="mx-auto max-w-6xl px-8 py-14">
                <header className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-base text-zinc-300">Manage users, content, and settings.</p>
                    </div>
                ...
                <main className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
                    <section className="col-span-2 rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur">
                        ...
                        <p className="mt-1 text-base text-zinc-300">
                            Quick overview of your controls. Choose an action below to get started.
                        </p>
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div className="rounded-lg border border-white/10 bg-black/20 p-5">
                                <h3 className="font-medium text-white text-lg">Content</h3>
                                <p className="mb-5 mt-1 text-sm text-zinc-400">Create, edit, and publish content.</p>
                                <Button variant="secondary" className="w-full text-black hover:text-black h-11 text-sm" asChild>
                                    <Link href="#">Manage Content</Link>
                                </Button>
                            </div>
                        </div>
                    </section>
