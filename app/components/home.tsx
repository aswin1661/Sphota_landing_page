...
export default function Home() {
    ...
    return(
        ...
        >
            ...
            <h1 className="fixed pt-[20vh] fixed berserker text-5xl">SPHOTA</h1>
            <h3 className="fixed text-center pt-[40vh] tahoma text-white text-[1.3vh] lg:text-[2vh] mr-[5vw] ml-[5vw] sm:text-[1.3vh]">
  ...
  when an unknown printer
            ...
            <button className="button mt-[65vh] fixed">
                R E J I S T E R
                <div id="clip">
